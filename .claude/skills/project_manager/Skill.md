...
- **记忆文档:** `jarvis-memory/L1_Episodic/02-Projects/{{项目名}}.md`
...
5. **创建记忆文档** `jarvis-memory/L1_Episodic/02-Projects/{{项目名}}.md`（Obsidian格式，含frontmatter）
...
| `jarvis-memory/L1_Episodic/02-Projects/XXX.md` | 项目记忆文档 | project_manager 创建，AI 在项目生命周期内更新 |
