...
- **每日 JSON 日志:** `jarvis-memory/L1_Episodic/01-Daily/.data/YYYY-MM-DD.json`（最近7天）
- **项目文件:** `jarvis-memory/L1_Episodic/Projects/*.md`
- **目标文件:** `jarvis-memory/L3_Semantic/metrics_goals.md`
- **任务状态:** `jarvis-memory/L0_Working/.current_task.json`
...
**保存位置：** `jarvis-memory/L1_Episodic/Weekly_Logs/YYYY-Www.md`
